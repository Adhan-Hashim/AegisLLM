  ...
  return (
    <div className="min-h-screen bg-[#111111] text-[#f4f4f4] font-sans selection:bg-orange-500/30 overflow-x-hidden">
      ...
      <main className="px-8 md:px-16 pt-4 pb-32 max-w-[1800px] mx-auto">
        {/* Hero Section */}
        <div className="max-w-7xl mx-auto flex flex-col items-center justify-center pt-8 pb-12">
          <div className="mb-4">
            <span className="text-orange-500 font-bold tracking-widest text-xs md:text-sm uppercase">
              (1) Enterprise-Grade Security
            </span>
          </div>
          
          <img src="/logo.png" alt="AegisLLM Logo" className="w-[120px] md:w-[160px] lg:w-[200px] object-contain opacity-95 mb-6 drop-shadow-2xl" />
